...
jest.mock("../src/services/receipt-intake", () => ({ analyzeReceiptImage: jest.fn(), analyzeTransactionText: jest.fn(), getReceiptAuthSession: jest.fn(), receiptExtractionToDraft: jest.fn(), receiptExtractionToDrafts: jest.fn(), uploadReceiptImage: jest.fn() }));
