						...
						const bubbleTone =
							stat.tone === "neutral"
								...
								: stat.tone === "accent"
									? "navy"
									: stat.tone || "primary";
						const iconColor = bubbleTone
							? theme.iconBubbles[bubbleTone].color
	...
	return (
		<Pressable
			...
			style={[
				...
				(loading || disabled) && styles.primaryButtonDisabled,
			]}
			onPress={onPress}
...
export function AuthLink({
	...
	const containerStyle =
		align === "center"
			? styles.linkContainerCenter
			: align === "right"
				? styles.linkContainerRight
