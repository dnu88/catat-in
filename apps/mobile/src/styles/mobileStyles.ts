...
export function createMobileStyles(theme: MobileTheme, viewportWidth?: number) {
  ...
  return StyleSheet.create({
    ...
    mobileHero: {
      ...
      borderWidth: 1,
      borderColor: theme.mode === 'light' ? theme.colors.glass.border : theme.colors.borderSoft,
      padding: theme.spacing.lg + 2,
      gap: theme.spacing.md,
      position: 'relative',
      overflow: 'hidden',
      ...(theme.mode === 'light' ? theme.shadow.md : null),
    },
    heroGlowOrb: {
      position: 'absolute',
      top: -60,
    ...
    walletPill: {
      ...
      backgroundColor: theme.mode === 'light' ? theme.colors.glass.background : theme.colors.glass.background,
      borderWidth: 1,
      borderColor: theme.mode === 'light' ? theme.colors.glass.border : theme.colors.glass.border,
      borderRadius: theme.radius.pill,
    ...
    deltaPill: {
      ...
      alignItems: 'center',
      gap: 4,
      backgroundColor: theme.mode === 'light' ? 'rgba(163,255,18,0.20)' : theme.colors.glass.background,
      borderRadius: 6,
      paddingVertical: 3,
      paddingHorizontal: 8,
    },
    deltaPillTrend: {
      color: theme.mode === 'light' ? theme.colors.brandPrimaryDeep : theme.colors.success,
      fontSize: 11,
      fontWeight: '800',
    },
    deltaPillText: {
      color: theme.mode === 'light' ? theme.colors.textPrimary : theme.colors.success,
      fontSize: 10,
      fontWeight: '800',
    },
    mobileHeroStats: {
    ...
    heroMiniStat: {
      flex: 1,
      backgroundColor: theme.mode === 'light' ? theme.colors.background : theme.colors.glass.background,
      borderWidth: 1,
      borderColor: theme.mode === 'light' ? theme.colors.glass.border : theme.colors.borderSoft,
      borderRadius: 14,
      padding: 10,
    ...
    heroMiniStatValueSuccess: {
      color: theme.colors.brandPrimaryDeep,
    },
    heroMiniStatValueDanger: {
    ...
    bottomNavIconActive: { backgroundColor: 'transparent' },
    bottomNavIconText: { color: theme.colors.textPrimary, ...type.captionStrong },
    bottomNavIconTextActive: { color: theme.colors.card },
    bottomNavLabel: { color: theme.colors.textMuted, fontSize: 10, fontWeight: theme.typography.fontWeight.semibold },
    ...
    splashLogoImage: { width: 56, height: 43 },
