...
export function getCategoryVisualMeta(
	...
	const categoryColorByName: Record<string, CategoryVisualMeta> = {
		...
		"rumah & perawatan": { color: roleColors.info, icon: "household", tone: "info" },
		"household & personal care": { color: roleColors.info, icon: "household", tone: "info" },
		"household personal care": { color: roleColors.info, icon: "household", tone: "info" },
		"personal care": { color: roleColors.info, icon: "household", tone: "info" },
