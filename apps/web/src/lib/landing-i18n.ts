...
const t = {
  id: {
    ...
    pricing: {
      ...
      allTiers: 'Semua tier: transaksi, dompet, budget, laporan, tema, dan privasi tanpa batas.',
    },
    features: {
      kicker: 'Fitur utama',
  ...
  en: {
    ...
    pricing: {
      ...
      allTiers: 'All tiers include: unlimited transactions, wallets, budgets, reports, themes, and privacy.',
    },
    features: {
      kicker: 'Key features',
