...
async def mayar_notification(request: Request):
    # Guard 3 — endpoint disabled until the operator opts in. Respond 404 so the
    ...
    # Optional soft-auth (Mayar has no cryptographic signature). When
